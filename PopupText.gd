...
["[center]Press 'A' to move left and 'D' to move right.\n(If you don't want to see the tip next time you come here press 'G')[/center]"],
["[center]Did you end up losing some lives? Need to save your progress?\n Press 'S' to restore your lives near posts like these.\nYou can have 10 lives at a time.\nTo save your progress you simply need to walk past the post.[/center]"],
